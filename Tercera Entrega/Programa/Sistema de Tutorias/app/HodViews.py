...
def add_staff_save(request):
    if request.method != "POST":
        ...
        try:
            ...
            messages.error(request, "   Error al agregar tutor")
            return redirect('add_staff')
...
def edit_staff_save(request):
    if request.method != "POST":
        ...
        try:
            ...
            messages.success(request, "Tutor actualizado con éxito.")
            return redirect('/edit_staff/'+staff_id)

        except:
            messages.error(request, "Tutor no actualizado.")
            return redirect('/edit_staff/'+staff_id)
...
def delete_staff(request, staff_id):
    ...
    try:
        staff.delete()
        messages.success(request, "Tutor eliminado con éxito.")
        return redirect('manage_staff')
    except:
        messages.error(request, "No se pudo eliminar Tutor.")
        return redirect('manage_staff')
...
def delete_course(request, course_id):
    ...
    try:
        ...
        messages.error(request, "No se pudo borrar el curso.")
        return redirect('manage_course')
...
def add_session_save(request):
    if request.method != "POST":
        ...
        try:
            ...
            messages.error(request, "No se pudo agregar semestre")
            return redirect("add_session")
...
def edit_session_save(request):
    if request.method != "POST":
        ...
        try:
            ...
            messages.success(request, "Año de sesión actualizado con éxito.")
            return redirect('/edit_session/'+session_id)
        except:
            messages.error(request, "No se pudo actualizar el año de la sesión.")
            return redirect('/edit_session/'+session_id)
...
def delete_session(request, session_id):
    ...
    try:
        ...
        messages.error(request, "Error al eliminar la sesión.")
        return redirect('manage_session')
    ...
    if request.method != "POST":
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.error(request, "¡No se pudo agregar al estudiante!")
                return redirect('add_student')
        else:
            return redirect('add_student')
    ...
    if request.method != "POST":
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.success(request, "Estudiante actualizada con éxito!")
                return redirect('/edit_student/'+student_id)
            except:
                messages.success(request, "No se pudo actualizar al estudiante.")
                return redirect('/edit_student/'+student_id)
        else:
            return redirect('/edit_student/'+student_id)
...
def delete_subject(request, subject_id):
    ...
    try:
        ...
        messages.error(request, "Erro al eliminar.")
        return redirect('manage_subject')
...
def admin_profile_update(request):
    if request.method != "POST":
        ...
        try:
            ...
            messages.error(request, "Error actualizando perfil")
            return redirect('admin_profile')
