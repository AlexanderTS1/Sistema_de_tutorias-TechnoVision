...
urlpatterns = [
    ...
    path('student_profile/', StudentViews.edit_student, name="student_profile"),
    path('student_profile_update/', StudentViews.edit_student_save, name="student_profile_update"),
